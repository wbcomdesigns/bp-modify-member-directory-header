						...
						foreach ( $profile_group->fields as $profile_field ) {
							...
							if ( in_array( $profile_field->id, $mergerd_loop_array ) && in_array( $profile_field->id, $xprofile_usr_fields_id_arr ) ) {
								...
								if ( ! empty( $profile_data ) ) {
									?>
									<div><span class=members-<?php echo esc_attr( $profile_field->name ); ?>><?php echo esc_html( $profile_field->name . ' : ' ); ?></span>
										<span class=members-value-<?php echo esc_attr( $profile_field->name ); ?>>
